  ...
  return (
    <main className="min-h-screen bg-[#FBF9F4] dark:bg-[#0D0D0D] text-[#171513] dark:text-[#FBF9F4] pb-16 selection:bg-[#C8A96A] selection:text-[#0D0D0D] transition-colors duration-300 font-sans">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pt-8 sm:px-6 lg:px-8 space-y-6 text-left">
        {/* Header Title Bar */}
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-[#E5DCCB] dark:border-[#333333] pb-6">
          <div>
            <span className="font-sans text-[9px] font-bold uppercase tracking-[0.3em] text-[#886D3B] dark:text-[#C8A96A]">
              INVENTORY & CATALOG
            </span>
            <h1 className="mt-2 font-brand text-3xl sm:text-4xl text-[#171513] dark:text-[#FBF9F4] font-light tracking-wide uppercase">
              Product Vault
            </h1>
          ...
          <div className="flex items-center gap-2">
            <span className="rounded-full border border-[#E5DCCB] dark:border-[#333333] bg-[#FFFDF8] dark:bg-[#1A1A1A] px-4 py-2 text-[9px] font-sans font-bold tracking-wider text-[#171513] dark:text-[#FBF9F4] uppercase shadow-sm dark:shadow-none">
        ...
        {/* Filter Tabs */}
        <div className="flex items-center gap-2.5 overflow-x-auto border-b border-[#E5DCCB] dark:border-[#333333] pb-3 scrollbar-none">
          {["All", "Published", "Low Stock", "Out of Stock"].map((tab) => (
            <button
              ...
              className={`rounded-full px-4 py-2 text-[9px] font-sans font-bold uppercase tracking-wider transition-all cursor-pointer ${activeTab === tab
                  ...
                  : "border border-[#E5DCCB] dark:border-[#333333] bg-[#FFFDF8] dark:bg-[#1A1A1A] text-[#716B63] dark:text-[#9A948B] hover:text-[#171513] dark:hover:text-[#FBF9F4] transition"
                }`}
            >
              {tab}
            </button>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {filteredProducts.map((product) => {
              ...
              return (
                <div
                  key={product._id}
                  className="flex flex-col justify-between overflow-hidden rounded-[18px] border border-[#E5DCCB] dark:border-[#333333] bg-[#FFFDF8] dark:bg-[#1A1A1A] shadow-[0_10px_30px_rgba(20,17,12,0.03)] dark:shadow-none transition duration-300 hover:border-[#C8A96A] hover:shadow-[0_10px_30px_rgba(20,17,12,0.06)]"
                >
                  <div className="relative aspect-[4/5] bg-[#F2EFE8] dark:bg-[#0D0D0D] overflow-hidden">
                    {imageUrl ? (
                      <img
                        src={imageUrl}
                        alt={product.title}
                      ...
                      <div className="flex h-full items-center justify-center text-[9px] text-[#716B63] dark:text-[#9A948B] uppercase tracking-widest font-bold bg-[#F2EFE8] dark:bg-[#0D0D0D]">
                        No Preview Image
                      </div>
                    )}
                    ...
                    <div className="absolute inset-x-3 top-3 flex justify-between">
                      ...
                      <span className="rounded-full border border-[#E5DCCB] dark:border-[#333333] bg-[#FFFDF8]/90 dark:bg-[#0D0D0D]/90 px-2.5 py-0.5 text-[8px] font-sans font-bold text-[#171513] dark:text-[#FBF9F4] uppercase tracking-wide">
                        {variantCount} var.
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-5 flex flex-1 flex-col justify-between text-left">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-sans font-bold text-[#886D3B] dark:text-[#C8A96A]">
                        {formatPrice(product.price)}
                      </p>
                      <p className="mt-2 line-clamp-2 text-[10px] leading-relaxed text-[#716B63] dark:text-[#9A948B] font-sans font-light">
                        {product.description}
                      </p>
                    </div>

                    <div className="mt-4 pt-3 border-t border-[#E5DCCB]/60 dark:border-[#333333]/60 flex items-center justify-between gap-2">
                      <span className="text-[9px] text-[#716B63] dark:text-[#9A948B] font-sans font-bold uppercase tracking-wide">
                        Total Stock: <strong className="text-[#171513] dark:text-[#FBF9F4] ml-1">{totalStock}</strong>
                      </span>

                      <Link to={`/seller/product/${product._id}`}>
                        <button
                          type="button"
                          className="h-8 px-4 border border-[#886D3B] text-[#171513] dark:text-[#FBF9F4] hover:bg-[#C8A96A] hover:text-[#0D0D0D] hover:border-transparent text-[9px] font-sans font-bold uppercase tracking-widest transition rounded-full cursor-pointer"
                        >
                          Variants
                        </button>
                      </Link>
          ...
          <Card className="p-16 text-center space-y-4 border border-[#E5DCCB] bg-[#FFFDF8]">
            <h3 className="font-brand text-2xl text-[#171513] dark:text-[#FBF9F4] font-light uppercase tracking-wide">No products found</h3>
            <p className="text-xs text-[#716B63] dark:text-[#9A948B] max-w-sm mx-auto leading-relaxed">
