...
function Register() {
  ...
  className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 active:bg-gray-100"
>
  <svg
    width="18"
    height="18"
  ...
  >
    ...
    <path
      fill="#34A853"
      d="M12 21.96c2.63 0 4.84-.87 6.45-2.37l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.69-1.72-5.46-4.03H3.3v2.53A9.74 9.74 0 0 0 12 21.96Z"
    />
    <path
      fill="#FBBC05"
      d="M6.54 14.03A5.86 5.86 0 0 1 6.23 12c0-.7.12-1.38.31-2.03V7.44H3.3A9.74 9.74 0 0 0 2.27 12c0 1.57.38 3.05 1.03 4.56l3.24-2.53Z"
    />
    <path
      fill="#EA4335"
      d="M12 5.94c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 2.99 14.63 2.04 12 2.04a9.74 9.74 0 0 0-8.7 5.4l3.24 2.53C7.31 7.66 9.46 5.94 12 5.94Z"
    />
  </svg>
